                        ...
                        <div id="dropdownAction"
                            ...
                            <div class="py-1">
                                <a href="#"
                                    ...
                                    User</a>
                                <a href="{{ route('admin.adduser') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Add User</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr
                                ...
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                        <input id="checkbox-table-{{ $user->id }}" type="checkbox"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <button data-modal-target="editUserModal-{{ $user->id }}"
